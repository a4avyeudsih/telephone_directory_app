...
public class EmployeeDetails extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db.rawQuery("SELECT emp._id, emp.firstName, emp.lastName, emp.title, emp.officePhone, emp.cellPhone, emp.email FROM employee emp WHERE emp._id = ?",
    ...
    public void onListItemClick(ListView parent, View view, int position, long id) {
        ...
        switch (action.getType()) {
            ...
            case EmployeeAction.ACTION_CALL:
               // if (intent.checkSelfPermission(manifests.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED) {
